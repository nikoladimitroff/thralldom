...
* Edits: Wrapped in a function and attached as a THREE module, Remove the auto-addition to the scene.
* Modified some of the example values
*/
...
(function () {
	...
	var PARTICLE_TEXTURE_ROOT = "Content/Textures/Particles/";
...
*/
	...
	/* 
		...
		particleTexture : THREE.ImageUtils.loadTexture( PARTICLE_TEXTURE_ROOT + 'star.png' ),
	...
	*/
	...
	Examples =
	{
		...
		fireball:
		{
			...
			particleTexture: THREE.ImageUtils.loadTexture(PARTICLE_TEXTURE_ROOT + 'smokeparticle.png'),
		...
		snow:
		{
			...
			particleTexture: THREE.ImageUtils.loadTexture(PARTICLE_TEXTURE_ROOT + 'snowflake.png'),
		...
		rain:
		{
			...
			velocitySpread: new THREE.Vector3(30, 50, 40),
			accelerationBase: new THREE.Vector3(0, -10, 0),
			accelerationSpread: new THREE.Vector3(2, 2, 2),

			particleTexture: THREE.ImageUtils.loadTexture(PARTICLE_TEXTURE_ROOT + 'raindroptest.png'),
		...
		starfield:
		{
			...
			particleTexture: THREE.ImageUtils.loadTexture(PARTICLE_TEXTURE_ROOT + 'spikey.png'),
		...
		fireflies:
		{
			positionStyle: Type.CUBE,
			positionBase: new THREE.Vector3(0, 0, 0),
			positionSpread: new THREE.Vector3(400, 25, 400),

			velocityStyle: Type.CUBE,
			velocityBase: new THREE.Vector3(0, 0, 0),
			velocitySpread: new THREE.Vector3(60, 20, 60),

			particleTexture: THREE.ImageUtils.loadTexture(PARTICLE_TEXTURE_ROOT + 'spark.png'),
	...
	THREE.ParticleEngine = ParticleEngine;
	THREE.ParticleEngineExamples = Examples;
})();
///////////////////////////////////////////////////////////////////////////////
